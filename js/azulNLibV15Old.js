...
class AzulFrag {
    ...
    constructor (frag, fbut) {
        this.fbut = fbut;
		this.fragRoot = frag.rend();
//        this.fbut.addEventListener('click', function() {azul.butfunc(fragRoot, azul.docbody);}, false);
    }
    render() {
        let fragRoot = this.fragRoot
        this.fbut.addEventListener('click', function() {azul.butfunc(fragRoot, azul.docbody);}, false);
    }
}
